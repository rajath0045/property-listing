...
export function Footer() {
  return (
    <footer className="bg-foreground text-card" data-analytics-surface="footer">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {/* Brand */}
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="inline-block mb-4" data-analytics-label="Footer brand">
          ...
          <div>
            ...
            <ul className="space-y-2 text-card/70">
              <li>
                <Link href="/#properties" className="hover:text-card transition-colors" data-analytics-label="Footer Our Stays">
                  Our Stays
                </Link>
              </li>
              <li>
                <Link href="/#reviews" className="hover:text-card transition-colors" data-analytics-label="Footer Reviews">
                  Reviews
                </Link>
              </li>
              <li>
                <Link href="/#contact" className="hover:text-card transition-colors" data-analytics-label="Footer Contact Us">
                  Contact Us
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-3 text-card/70">
              <li className="flex items-center gap-2">
                ...
                <a
                  ...
                  data-analytics-label="Footer phone"
                >
                  +91 98765 43210
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a
                  href="mailto:hello@gokulamstays.com"
                  className="min-w-0 break-all hover:text-card transition-colors"
